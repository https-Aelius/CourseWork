...
<body>
    ...
    <main style="background-color:#fff;">
            ...
            <div class="container" style='min-height:auto; padding-top:0vh; width:100%;'>
                <div class="innerContainer" style="min-height:auto; border-top:0; border-bottom:0;">
                    <ul class="breadcrumb" style='margin-bottom:16px; background-color:#fff !important;'>
                        ...
                        <li><a href="supportPage.php" style='text-decoration:none; color:#2c2c2c;'>Support Page</a></li>
                    </ul>
        ...
        <div class="contact-us-card-section" style="min-height:100dvh; padding-top:75px; padding-bottom:100px;">
                ...
                <div class="support-us-column">
                    <div class="flex-auto">
                        <div class="content-card">
                            <div style="margin-top:0; margin-bottom:.5rem;">
                                <br>
                                <h5 style="font-size: 22px; line-height: 1; color:#000; font-weight:500; letter-spacing:0.36px;">Affiliate & Influencer Requests</h5>
                                <br>
                                <p class="about-us-text">
                                ...
                                <br>
                                <p class="about-us-text">
                                    We welcome all collaborators and influencers who align with our brand values.
                                </p>
                                <br>
                                <p class="about-us-text">
                                    <a class="email-link" href="mailto:MARKETING@HYDRAPEAK.COM">
                                        MARKETING@HYDRAPEAK.COM
                                    </a>
                                </p>
                            </div>
                        </div>
                ...
                <div class="support-us-column">
                    <div class="flex-auto">
                        <div class="content-card">
                            <div style="margin-top:0; margin-bottom:.5rem;">
                                <br>
                                <h5 style="font-size: 22px; line-height: 1; color:#000; font-weight:500; letter-spacing:0.36px;">Press & Collaborations
                                </h5>
                                <br>
                                <p class="about-us-text">
                                    For media or stylist requests and brand collaborations
                                </p>
                                <p class="about-us-text">
                                    <a class="email-link" href="mailto:MARKETING@HYDRAPEAK.COM">
                                        MARKETING@HYDRAPEAK.COM
                                ...
                                <br>
                                <p class="about-us-text">
                                    For Bulk Orders & Corporate Events
                                </p>
                                <p class="about-us-text">
                                    <a class="email-link" href="mailto:SALES@HYDRAPEAK.COM">
                                        SALES@HYDRAPEAK.COM
                                    </a>
                                </p>
                                <br>
                ...
                <div class="support-us-column">
                    <div class="flex-auto">
                        <div class="content-card">
                            <div style="margin-top:0; margin-bottom:.5rem;">
                                <br>
                                <h5 style="font-size: 22px; line-height: 1; color:#000; font-weight:500; letter-spacing:0.36px;">Store Location</h5>
                                <br>
                                <p class="about-us-text">
                                    Based in Chicago, IL, our flagship store offers a hands-on experience with our products.
                                </p>
                                <br>
                                <p class="about-us-text" style="text-decoration:underline;">
                                    1840 W Hubbard St, Chicago, IL 60622, United States
                                </p>
                                <br>
                            </div>
                        </div>
                ...
                <div class="support-us-column">
                    <div class="flex-auto">
                        <div class="content-card">
                            <div style="margin-top:0; margin-bottom:.5rem;">
                                <br>
                                <h5 style="font-size: 22px; line-height: 1; color:#000; font-weight:500; letter-spacing:0.36px;">Contact Us</h5>
                                <br>
                                <p class="about-us-text">
                                    TEXT ONLY: US & CANADA
                                </p>
                ...
                <div class="support-us-column">
                    <div class="flex-auto">
                        <div class="content-card">
                            <div style="margin-top:0; margin-bottom:.5rem;">
                                <br>
                                <h5 style="font-size: 22px; line-height: 1; color:#000; font-weight:500; letter-spacing:0.36px;">Returns & Exchanges</h5>
                                <br>
                                <p class="about-us-text">
                                ...
                                <br>
                                <p class="about-us-text">
                                    <a class="email-link" href="mailto:SUPPORT@HYDRAPEAK.COM">
                                        SUPPORT@HYDRAPEAK.COM
                                    </a>
                                </p>
                            </div>
                        </div>
