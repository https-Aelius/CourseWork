...
<head>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=YOUR_CLIENT_ID&currency=USD"></script> <!--For future reference I need to add my own Sandbox testing into YOUR_CLIENT_ID-->
        ...
        <div class="col-md-6">  
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="card-header p-0">
                    <h2 class="mb-0">
                    <a href='checkout_logic.php' type='button' class="btn btn-light btn-block text-left p-3 rounded-0" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        <div class="d-flex align-items-center justify-content-between">
                ...
                $_SESSION['toPayCents'] = number_format($toPay,2) * 100;
                ...
                <p style='font-size:10px; margin-left:50%;'>To pay, press on one of the methods above</p>
