            ...
            <div class="container" style='min-height:auto; padding-top:0vh; width:100%;'>
                <div class="innerContainer" style="min-height:auto; border-bottom:1px solid #2c2c2c;">
                    <ul class="breadcrumb" style='margin-bottom:16px; line-height:1.1'>
                        ...
                        <li><a href="waterBottleSec.php" style='text-decoration:none; color:#2c2c2c;'>Accessories</a></li>
                    </ul>
                    ...
                    <div class="column" style="display: flex; align-items: flex-end; gap:32px;">
                        <h1  style=" line-height:1.1; margin-bottom:1.5vh;">Accessories</h1>
                    </div>        
            ...
            <!-- 1st card -->
                <li class="grid__item product-custom-card">
                    ...
                    <div class="card__media">
                        ...
                        <img class="card__image" src="Images/Pre database Image/il_1588xN.7058803093_fdob.avif" alt="" style=" width:100% !important; height:100% !important; position: relative; min-height: 500px; overflow-clip-margin: content-box; overflow: clip;">
                ...
                <!-- 2nd card-->
                 <?php
                 include_once('connection.php');
                 $stmt = $conn->prepare("SELECT * FROM Products WHERE productType = 'Accessories'");
                 $stmt->execute();
                 if($stmt->rowCount()>0){
